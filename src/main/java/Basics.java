...
public class Basics {
    ...
    public static String split(String to_split) {
        ...
        // Array contains all 7 words in to_split

        for (int i=0;i<=6;i++) {
            char charToAdd = stringArray[i].charAt(0); // Get first char of ith string in array
            ret.append(charToAdd); // Add char to ret StringBuilder string
        }
